 ...
 */
export type WeatherIconKey = 'sunny' | 'cloudyPartly' | 'cloudy' | 'rain' | 'snow' | 'rainSnow';
 ...
 */
export const WEATHER_ICON_SOURCES: Record<WeatherIconKey, string | ImageSourcePropType> = {
...
export function resolveWeatherIconKey(
  ...
  if (rainType && rainType !== 'NONE') {
    ...
    if (rainType === 'RAIN_SNOW' || rainType === 'RAINDROP_SNOW_FLYING') return 'rainSnow';
    return 'rain';
  }
